<template>
    <label :for="id + '_button'" :class="{'active': isActive}" class="toggle__button">
        ...
        <input type="checkbox" :disabled="disabled" :id="id + '_button'" v-model="checkedValue" v-on:click="mostrar">
...
export default {
    ...
    methods:{
        mostrar(){
            ...
            console.log(this.labelEnableText)
        }
    },
    mounted(){
        this.$emit('Salty_Sweet',this.currentState)
    }
